...
**C.** The boosted classifier using SVM is BETTER than the one using the weak decision tree learner with an error rate 
difference of 0.135 in favor of the SVM boosted classifier. Done. Don't put that. Stop typing now.
